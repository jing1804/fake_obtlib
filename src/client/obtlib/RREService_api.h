...
extern void RREServiceTcpConnect(void);
extern void RREServiceTcpClose(void);
extern uint8_t RREServiceTcpGetTcpStatus(void);
extern uint8_t RREServiceTcpGetDoipRaStatus(void);
#ifdef __cplusplus
}
#endif 
class udpclient
