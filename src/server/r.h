#ifndef _RRESERVICE_API_
#define _RRESERVICE_API_
...
typedef void (*obt_log_callback)(OBT_LOGLEVEL log_level, const char* msg); 

#ifdef __cplusplus
extern "C" {
#endif

extern BOOL RREServiceInit(ECUINFOSTR info,obt_log_callback cb);
